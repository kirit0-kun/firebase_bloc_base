...
class PaginatedResult<T> extends PaginatedParam {
  ...
  PaginatedResult copyWith(
    ...
    var param = startAfter != null || count != null
        ...
        : null;
    return PaginatedResult<T>(result ?? this.result, param);
  }
}
...
class PaginatedFirebaseQuerySwitcher extends BaseFirebaseQuerySwitcher {
  ...
  const PaginatedFirebaseQuerySwitcher({
    this.paginatedParam,
    List<MapEntry<String, dynamic>> isEqualTo,
    List<MapEntry<String, dynamic>> isNotEqualTo,
    List<MapEntry<String, dynamic>> isLessThan,
    List<MapEntry<String, dynamic>> isLessThanOrEqualTo,
    List<MapEntry<String, dynamic>> isGreaterThan,
    List<MapEntry<String, dynamic>> isGreaterThanOrEqualTo,
    List<MapEntry<String, dynamic>> arrayContains,
